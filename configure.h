...
#define STEPS_PER_TURN_R     (200.0)  // default number of steps per turn * microsteps
...
#define ADDR_HOMEZ              (ADDR_HOMEY+4)             // float - 4 bytes
#define ADDR_CALIBRATION_LEFT   (ADDR_HOMEZ+4)             // float - 4 bytes
